        ...
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center space-y-6 max-w-4xl mx-auto px-6">
            ...
            <div className='flex space-x-6 justify-center'>
              ...
              {/* <button className=' border shadow-2xl shadow-slate-400 border-slate-800 px-8 py-4 rounded text-white hover:text-black hover:bg-white transition duration-300'>Start Chat</button> */}
