...
<div className='bg-black flex flex-col gap-0 relative'>
        <div className='text-white text-5xl   absolute mt-40 ml-72'
        >Hi there!
        <motion.div
        initial={{ opacity: 0 ,width:"0rem",height:"0rem"}}
        animate={{ opacity: 1,width:"54rem",height:"0.15rem" }}
        transition={{duration:1.5}}
        className='h-[0.15rem] shadow shadow-white -translate-y-7 translate-x-52 w-[54rem] bg-pink-300' style={
          {
            boxShadow: "0px 8px 30px 15px rgba(255, 255, 255, 0.9);",
